...
{  
	...
	for (int i = 0; i < data.length; i++)
		...
		System.out.println("week2.week3.arrays equal before sort: "+Arrays.equals(data, orig));
		Arrays.sort(data); // sorting the data array (orig is unchanged)
		System.out.println("week2.week3.arrays equal after sort: " + Arrays.equals(data, orig));
