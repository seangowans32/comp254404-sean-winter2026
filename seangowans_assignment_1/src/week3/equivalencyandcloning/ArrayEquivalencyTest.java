...
public class ArrayEquivalencyTest {
	...
	public static void main(String[] args) {
		...
		//testing two dimensional week3.arrays
		int[][] a = { {1,5}, {2,6} };
		int[][] b = { {1,5}, {2,6} };
		//shallow comparison with two dim week3.arrays
		System.out.println("Shallow comparison with two dim week3.arrays");
		if (Arrays.equals(a, b) || a == b)
		    System.out.println("Arrays are equal");
		else
		    System.out.println("Arrays ore not equal.");
		//deep comparison with two dim week3.arrays
		System.out.println("Deep comparison with two dim week3.arrays");
