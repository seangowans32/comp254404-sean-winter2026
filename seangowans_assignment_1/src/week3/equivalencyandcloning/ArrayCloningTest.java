...
public class ArrayCloningTest {
	...
	public static void main(String[] args) {
		...
		printArray(data);
		//deep copy of 1-dim week3.arrays
		backup=data.clone();
		...
		printArray(data);
		//
		System.out.println("deep copy of two-dimensional week3.arrays");
		//deep copy of two-dimensional week3.arrays
	...
	{ 
		int[ ][ ] backup = new int[original.length][ ]; // create top-level array of week3.arrays
